...
extern "C" void Java_com_example_mira4u_P2pSinkActivity_nativeInvokeSink(JNIEnv* env, jobject thiz, jstring ipaddr, jint port, jint special) {
    ...
    ALOGV("Sink Display[%d, %d] Special[%d]", displayWidth, displayHeight, specialMode);
...
extern "C" void Java_com_example_mira4u_WfdActivity_nativeInvokeSink(JNIEnv* env, jobject thiz, jstring ipaddr, jint port) {
    Java_com_example_mira4u_P2pSinkActivity_nativeInvokeSink(env, thiz, ipaddr, port, 0);
}
